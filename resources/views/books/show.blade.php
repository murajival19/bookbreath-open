...
@section('content')
<div class="container container-book-show">
        ...
        <div class="col-md-10">
            ...
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-12 col-sm-8">
                                    <div class="card-body">
                                        ...
                                        <a class="btn btn-outline-info btn-sm" href="{{ route('posts.create', [
                                            'book_id' => $book->id,
                                            ]) }}">ブレスを投稿する</a>
                                        {{-- 本の購入 --}}
                                        <span class="dropdown mr-1">
                                            <button type="button" class="btn dropdown-toggle btn-sm btn-buy" id="dropdownMenuOffset" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-offset="10,20">
                                                購入する
                                            </button>
                        ...
                        @else
                            <h5 class="mb-3">{{ $book->book_title }}のブレス</h5>
                        @endif
